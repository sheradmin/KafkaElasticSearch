package com.sheradmin.kafka.repository;

import com.sheradmin.kafka.KafkaElasticSearchApp;
import com.sheradmin.kafka.config.Constants;
import com.sheradmin.kafka.config.audit.AuditEventConverter;
import com.sheradmin.kafka.domain.PersistentAuditEvent;
...
import static com.sheradmin.kafka.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
